...
abstract class AppLocalizations {
  ...
  /// No description provided for @loginDifferentAccountTitle.
  ///
  /// In en, this message translates to:
  /// **'Different account detected'**
  String get loginDifferentAccountTitle;

  /// No description provided for @loginDifferentAccountBody.
  ///
  /// In en, this message translates to:
  /// **'This device remembers account {handle}. Do you want to continue with this new account?'**
  String loginDifferentAccountBody(Object handle);

  /// No description provided for @loginDifferentAccountContinue.
  ///
  /// In en, this message translates to:
  /// **'Continue with this account'**
  String get loginDifferentAccountContinue;

  /// No description provided for @loginDifferentAccountCancelled.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @loginAccountConflictTitle.
  ///
  /// In en, this message translates to:
  /// **'Account already exists'**
  String get loginAccountConflictTitle;

  /// No description provided for @loginAccountConflictBody.
  ///
  /// In en, this message translates to:
  /// **'An account with {email} already exists using {provider}. Sign in with {provider} first to link your accounts.'**
  String loginAccountConflictBody(Object email, Object provider);

  /// No description provided for @loginAccountConflictLink.
  ///
  /// In en, this message translates to:
  /// **'Sign in and link'**
  String get loginAccountConflictLink;
  ...
  /// No description provided for @welcomeBackQuickSignInUnavailable.
  ///
  /// In en, this message translates to:
  /// **'Quick sign-in is unavailable. Tap \"Not you?\" to use another account.'**
  String get welcomeBackQuickSignInUnavailable;

  /// No description provided for @welcomeBackUidMismatch.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @groupHubTitle.
  ///
  /// In en, this message translates to:
  /// **'Choose your group'**
  String get groupHubTitle;
  ...
  /// No description provided for @settingsSwitchGroup.
  ///
  /// In en, this message translates to:
  /// **'Switch group'**
