...
class MatchdayState extends ChangeNotifier {
  ...
  // Default cursor for fresh installs. The live sync corrects this
  // within seconds via API-Football or Firestore query.
  static const int _kCassandraDefaultMatchdayCursor = 1;
